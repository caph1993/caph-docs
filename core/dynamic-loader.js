...
/// <reference path="jsdocs-for-libraries.js" />
...
const caph = new class {
  ...
  parse({ raw: strings }, ...values) {
    return this._parser.parse(true, strings, ...values);
  }
  ...
  parseNoMarkup({ raw: strings }, ...values) {
    return this._parser.parse(false, strings, ...values);
  }
